 ...
 <div class="row wrapper border-bottom white-bg page-heading">
	<div class="col-lg-10">
		...
		<ol class="breadcrumb">
			...
			<li class="active"><strong>Banners</strong>
			</li>
		</ol>
	</div>
...
<div class="wrapper wrapper-content animated fadeInRight">
	<div id="add_edit_banner_container">
	</div>
	<p>
	<div class="row">
		<div class="col-lg-12">
			<div class="ibox float-e-margins">
				<div class="ibox-title">
					<h5>Matenimiento de Banner Principal</h5>
	...
	<div class="modal inmodal" id="myModalDeleteBanner" tabindex="-1"
		role="dialog" aria-hidden="true" banner_id=''>
		<div class="modal-dialog">
			<div class="modal-content animated fadeIn">
				...
				<div class="modal-footer">
					...
					<button type="button"
						class="btn btn-primary eliminar-banner-trigger"
						data-dismiss="modal">
						<?php echo __('Aceptar'); ?>
					</button>
				</div>
